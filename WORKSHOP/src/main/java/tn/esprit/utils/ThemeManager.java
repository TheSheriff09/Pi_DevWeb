...
public final class ThemeManager {
     ...
     * on the scene's root node (same level as the FXML {@code stylesheets}
     * attribute).
     */
    public void applyTo(Scene scene) {
        if (scene == null || lightCssUrl == null)
            return;
